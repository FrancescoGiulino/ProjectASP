...
{
	public class AiMessage_TaskType : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_TaskType(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				for(int i_2 = 0; i_2 < AiMessages_2.Count; i_2++)
				{
					...
					string TaskType_3 = AiMessages_2[i_2].TaskType;
					if(TaskType_3 == null)
					{
						values[i_2].Clear();
						continue;
