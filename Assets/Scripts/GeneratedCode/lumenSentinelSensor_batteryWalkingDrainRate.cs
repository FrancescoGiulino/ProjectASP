...
{
	public class lumenSentinelSensor_batteryWalkingDrainRate : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_batteryWalkingDrainRate(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				float batteryWalkingDrainRate_4 = Resources_3.batteryWalkingDrainRate;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(batteryWalkingDrainRate_4);
			}
		}
