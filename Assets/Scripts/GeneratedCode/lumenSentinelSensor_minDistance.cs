...
{
	public class lumenSentinelSensor_minDistance : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_minDistance(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				float minDistance_3 = Resources_2.minDistance;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(minDistance_3);
			}
		}
