...
{
	public class lumenSentinelSensor_secondaryAmmo : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_secondaryAmmo(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				int secondaryAmmo_4 = Resources_3.secondaryAmmo;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(secondaryAmmo_4);
			}
		}
