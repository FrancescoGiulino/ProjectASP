...
{
	public class lumenSentinelSensor_walkSpeed : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_walkSpeed(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				float walkSpeed_3 = Resources_2.walkSpeed;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(walkSpeed_3);
			}
		}
