...
{
	public class AiMessage_X : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_X(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
