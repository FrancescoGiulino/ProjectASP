...
{
	public class AiMessage_ID : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_ID(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
