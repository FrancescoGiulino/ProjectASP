...
{
	public class AiMessage_Z : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_Z(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
