...
{
	public class lumenSentinelSensor_batteryRunningDrainRate : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_batteryRunningDrainRate(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				float batteryRunningDrainRate_4 = Resources_3.batteryRunningDrainRate;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(batteryRunningDrainRate_4);
			}
		}
