...
{
	public class lumenSentinelSensor_primaryAmmo : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_primaryAmmo(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				int primaryAmmo_4 = Resources_3.primaryAmmo;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(primaryAmmo_4);
			}
		}
