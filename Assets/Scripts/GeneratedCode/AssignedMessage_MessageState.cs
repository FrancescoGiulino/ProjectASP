...
{
	public class AssignedMessage_MessageState : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "assignedMessage_MessageState(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				for(int i_2 = 0; i_2 < AssignedMessages_2.Count; i_2++)
				{
					...
					string MessageState_3 = AssignedMessages_2[i_2].MessageState;
					if(MessageState_3 == null)
					{
						values[i_2].Clear();
						continue;
					}
