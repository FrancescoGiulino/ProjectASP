...
{
	public class AiMessage_Y : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_Y(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
