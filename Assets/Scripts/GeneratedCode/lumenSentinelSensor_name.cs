...
{
	public class lumenSentinelSensor_name : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_name(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				string name_3 = EnemyStateController_2.name;
				if(name_3 == null)
				{
					values.Clear();
					return;
