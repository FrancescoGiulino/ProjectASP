...
{
	public class lumenSentinelSensor_batteryIdleDrainRate : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_batteryIdleDrainRate(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				float batteryIdleDrainRate_4 = Resources_3.batteryIdleDrainRate;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(batteryIdleDrainRate_4);
			}
		}
