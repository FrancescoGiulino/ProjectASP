...
{
	public class AiMessage_MessageState : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "aiMessage_MessageState(worldInformationManager,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				for(int i_2 = 0; i_2 < AiMessages_2.Count; i_2++)
				{
					...
					string MessageState_3 = AiMessages_2[i_2].MessageState;
