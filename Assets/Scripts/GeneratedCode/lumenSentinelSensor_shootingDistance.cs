...
{
	public class lumenSentinelSensor_shootingDistance : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_shootingDistance(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				int shootingDistance_4 = Resources_3.shootingDistance;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
				values.Add(shootingDistance_4);
			}
		}
