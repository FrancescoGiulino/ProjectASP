...
{
	public class lumenSentinelSensor_Z : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "lumenSentinelSensor_Z(lumenSentinel,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				int Z_3 = EnemyStateController_2.Z;
				if (values.Count == 1)
				{
					values.RemoveAt(0);
				}
